              ...
              <div className="p-3 sm:p-6 bg-white/90 dark:bg-gray-800/90 rounded-xl backdrop-blur-sm shadow-sm">
                <div className="flex items-center gap-3 sm:gap-4 mb-2 sm:mb-4">
                  <div className="p-2 sm:p-3 rounded-full bg-emerald-100 dark:bg-emerald-900">
                    <PiggyBank className="w-4 h-4 sm:w-6 sm:h-6 text-emerald-600 dark:text-emerald-400" />
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-base sm:text-xl font-semibold text-gray-900 dark:text-gray-100">With your savings, you could get</span>
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger className="cursor-help">
                          <Info className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400" />
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center justify-between text-xs sm:text-sm py-2">
                      <span className="text-gray-600 dark:text-gray-300 flex items-center gap-2">
                        <Plane className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-600" /> International Trips
                      </span>
                    ...
                    <div className="flex items-center justify-between text-xs sm:text-sm py-2">
                      <span className="text-gray-600 dark:text-gray-300 flex items-center gap-2">
                        <Smartphone className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-600" /> Premium Smartphones
                      </span>
                      <span className="font-semibold text-emerald-600">
                    ...
                    <div className="flex items-center justify-between text-xs sm:text-sm py-2">
                      <span className="text-gray-600 dark:text-gray-300 flex items-center gap-2">
                        <Palmtree className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-600" /> Dream Family Vacation
                      </span>
                      <span className="font-semibold text-emerald-600">
                        1 trip
                      </span>
                  ...
                  <div className="text-xs sm:text-sm text-center text-gray-500 dark:text-gray-400 mt-2 sm:mt-3">
