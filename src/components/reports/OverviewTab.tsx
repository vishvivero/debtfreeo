    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-sm">
            ...
            <CardContent>
              <p className="text-2xl font-bold text-slate-900 dark:text-slate-100">{formatCurrency(totalDebt)}</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-sm">
            ...
            <CardContent>
              <p className="text-2xl font-bold text-slate-900 dark:text-slate-100">{averageInterestRate.toFixed(2)}%</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-sm">
            ...
            <CardContent>
              <p className="text-2xl font-bold text-slate-900 dark:text-slate-100">{formatCurrency(totalMinimumPayment)}</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-sm">
            ...
            <CardContent>
              <p className="text-2xl font-bold text-slate-900 dark:text-slate-100">{Object.keys(categories).length}</p>
            </CardContent>
          </Card>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-sm">
            <CardHeader>
              <CardTitle className="text-slate-800 dark:text-slate-200">Debt Distribution</CardTitle>
        ...
        >
          <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-sm">
            <CardHeader>
              <CardTitle className="text-slate-800 dark:text-slate-200">Debt Categories</CardTitle>
              ...
              <ScrollArea className="h-[300px] pr-4">
                <div className="space-y-4">
                  {Object.entries(categories).map(([category, amount]) => (
                    <div key={category} className="flex justify-between items-center py-2 border-b border-slate-100 dark:border-slate-800">
        ...
        <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-sm">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h4 className="font-medium text-slate-700 dark:text-slate-300">Report Contents:</h4>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button 
                        ...
                        className="w-full sm:w-auto bg-slate-800 hover:bg-slate-700 text-white flex items-center gap-2"
                      >
