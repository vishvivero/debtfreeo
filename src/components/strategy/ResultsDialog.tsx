  ...
  return <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
        <AnimatePresence mode="wait">
          {currentView === 'insights' && <motion.div key="insights" initial={{
          opacity: 0,
          x: 100
        }} animate={{
          opacity: 1,
          ...
          {currentView === 'timeline' && <motion.div key="timeline" initial={{
          opacity: 0,
          x: 100
        }} animate={{
          opacity: 1,
          ...
          duration: 0.3
              ...
              <div className="mt-4">
                ...
                <div className="mt-6 flex justify-between gap-4">
                  ...
                  <Button className="flex items-center gap-2 bg-[#00D382] hover:bg-[#00D382]/90 text-white" onClick={handleNext}>
                    Next
          ...
          {currentView === 'initial' && <motion.div key="initial" initial={{
          opacity: 0,
          x: 100
        }} animate={{
          opacity: 1,
          ...
          duration: 0.3
              ...
              delay: 0.4
                ...
                {hasOneTimeFundings && <motion.div initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
